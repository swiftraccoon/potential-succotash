const config = {
    privateKeyPath: 'server.key', // path to private key
    certificatePath: 'server.cert', // path to certificate
    WEBAUTHN_RP_NAME: 'RuCoCAD', // name of the relying party
    WEBAUTHN_RP_ID: 'localhost', // domain of the relying party
